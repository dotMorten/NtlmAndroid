...
namespace System.Formats.Asn1
{
    ...
    internal sealed partial class AsnWriter
    {
        ...
        public int GetEncodedLength()
        {
            ...
            {
                throw new InvalidOperationException("Encode cannot be called while a Sequence, Set-Of, or Octet String is still open.");
            }
        ...
        private void PopTag(Asn1Tag tag, UniversalTagNumber tagType, bool sortContents = false)
        {
            ...
            {
                throw new InvalidOperationException("Cannot pop the requested tag as it is not currently in progress.");
            }
