    ...
    internal static partial class AsnDecoder
    {
            ...
            out int bytesConsumed)
        {
            ...
            if (actualTag.IsConstructed)
            {
                ...
                {
                    throw new AsnContentException("The encoded value is not valid under the selected encoding, but it may be valid under the BER or CER encoding.");
                }
            ...
            {
                throw new AsnContentException("The encoded value is not valid under the selected encoding, but it may be valid under the BER or DER encoding.");
            }
            ...
            bool isIndefinite)
        {
            ...
            {
                throw new AsnContentException("The encoded value is not valid under the selected encoding, but it may be valid under the BER encoding.");
            }
