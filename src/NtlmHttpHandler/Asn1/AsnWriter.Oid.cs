    ...
    internal sealed partial class AsnWriter
    {
        ...
        private void WriteObjectIdentifierCore(Asn1Tag tag, ReadOnlySpan<char> oidValue)
        {
            ...
            if (oidValue.Length < 3)
                throw new ArgumentException("The OID value is invalid.", nameof(oidValue));
            if (oidValue[1] != '.')
                throw new ArgumentException("The OID value is invalid.", nameof(oidValue));
            ...
            try
            {
                int firstComponent = oidValue[0] switch
                {
                    ...
                    '1' => 1,
                    '2' => 2,
                    _ => throw new ArgumentException("The OID value is invalid.", nameof(oidValue)),
                };
        ...
        private static int AtoI(char c)
        {
            ...
            throw new ArgumentException("The OID value is invalid.", "oidValue");
        }
